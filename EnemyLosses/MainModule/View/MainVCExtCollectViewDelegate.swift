//
//  MainVCExtCollectViewDelegate.swift
//  EnemyLosses
//
...
extension MainViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if !mainView.dataLossesEquipment.isEmpty {
            ...
            cell.title.text = mainView.cellLossesEquipment[indexPath.row].equipment
            cell.image.image = UIImage(named: mainView.cellLossesEquipment[indexPath.row].image)
        }
        return cell
    }
}
